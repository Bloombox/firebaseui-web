...
firebaseui.auth.ui.page.IJ_DATA_ = {
  ...
  microsoftLogo: 'https://docs.microsoft.com/en-us/azure/active-directory/develop/media/howto-add-branding-in-azure-ad-apps/ms-symbollockup_mssymbol_19.png',
...
firebaseui.auth.ui.page.Base.prototype.startProcessing_ = function() {
  ...
  // indicator.
  const useSpinner =
      goog.dom.classlist.contains(self.getElement(), goog.getCssName('firebaseui-use-spinner'));
